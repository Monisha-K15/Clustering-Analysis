...
SEGMENT_COLORS = {
    ...
    'Affluent Loyalists':  '#3498db',
    'Deal-Seeking Families':'#e67e22',
    'Budget Families':     '#e74c3c',
}
    ...
    with col2:
        ...
        for seg in all_segments:
            ...
            <div style="background:white; border-left: 4px solid {color};
                ...
                <div style="color:#555; font-size:0.82rem; margin-top:4px">{desc}</div>
            </div>
            """, unsafe_allow_html=True)
...
with tab5:
    ...
    if predict_btn:
        ...
        with res1:
            st.markdown(f"""
            <div style="background:white; border: 3px solid {color};
        ...
        with res2:
            ...
            <div style="background:white; border-left: 5px solid {color};
                ...
                <div style="color:#444; font-size:0.95rem; line-height:1.7">{desc}</div>
            </div>
            """, unsafe_allow_html=True)
        ...
        fig_loc.update_layout(
            ...
            xaxis=dict(showgrid=True, gridcolor='#f0f0f0', title='PC1'),
            yaxis=dict(showgrid=True, gridcolor='#f0f0f0', title='PC2'),
            legend=dict(orientation='h', yanchor='bottom', y=1.02, xanchor='right', x=1),
        )
